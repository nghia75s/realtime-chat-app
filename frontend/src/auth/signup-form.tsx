...
import { Eye, EyeOff, LoaderIcon, Check, X, MessageCircle } from "lucide-react"
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="bg-black/35 border border-white/10 text-white placeholder:text-zinc-600 rounded-lg py-2.5 pl-3 pr-16 text-[15px] focus:border-[#38bdf8] focus:ring-1 focus:ring-[#38bdf8]/50 transition-all outline-none w-full"
                    />
