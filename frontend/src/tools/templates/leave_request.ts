...
export const leaveRequestTemplate: DocumentTemplate = {
  id: "leave_request",
  ...
  templateContent: `
    <div style="font-family:'Times New Roman',Times,serif;font-size:16px;line-height:1.6;color:black;max-width:100%;">
      ...
      <div style="text-align:center;margin-bottom:30px;">
        <h2 style="font-size:24px;font-weight:bold;margin:0;letter-spacing:1px;">ĐƠN XIN NGHỈ PHÉP</h2>
      </div>
      ...
      <div style="margin-bottom:15px;">
        <p>Nay tôi làm đơn này xin phép Ban Giám đốc cho tôi được nghỉ phép với lý do sau:</p>
      ...
      <div style="display:flex;justify-content:space-between;margin-top:50px;">
        <div style="text-align:center;width:45%;">
          ...
          <p style="font-style:italic;font-size:14px;margin:4px 0;">(Ký và ghi rõ họ tên)</p>
