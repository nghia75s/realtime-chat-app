   ...
   return (
    <div className="flex flex-col w-full h-[550px] bg-chat-sidebar relative animate-in slide-in-from-right-4 duration-200">
        ...
        <div className="px-5 py-6 flex flex-col gap-6 items-center flex-1 outline-none">
            <Button variant="outline" className="w-[85%] h-[44px] flex items-center justify-center gap-2 border-[1.5px] border-[#7c3aed] text-[#7c3aed] font-bold bg-[#ede9fe]/70 hover:bg-[#ede9fe] dark:bg-[#7c3aed]/20 dark:hover:bg-[#7c3aed]/30 dark:text-[#a78bfa] dark:border-[#a78bfa] text-[15px] transition-colors rounded-lg shadow-sm">
