...
function NoChatsFound() {
  ...
  return (
    <div className="flex-1 flex-col items-center justify-center py-10 text-center space-y-4">
      <div className="w-16 h-16 bg-purple-500/10 rounded-full flex items-center justify-center">
        <MessageCircleIcon className="w-8 h-8 text-purple-400" />
      </div>
      <div>
        <h4 className="text-purple-200 font-medium mb-1">No conversations yet</h4>
